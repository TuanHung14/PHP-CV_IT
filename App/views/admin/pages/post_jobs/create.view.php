  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        ?>
        <form class="forms-sample" action="/admin-panel/post_job/store" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="number" min="0" name="quantity" class="form-control" value="<?= isset($job['quantity']) ? $job['quantity'] : "" ?>" id="exampleInputEmail3" placeholder="Số lượng">
