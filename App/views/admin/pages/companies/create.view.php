  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        ?>
        <form class="forms-sample" action="/admin-panel/company/store" method="POST" enctype="multipart/form-data">
          <div class="form-group">
            <input type="file" name="thumbnail" class="file-upload-default" style="display: none;">
            <div class="image-upload-wrapper">
              <img src="/images/avatar.png" alt="Upload Image" class="image-preview rounded-circle">
            </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" value="<?= isset($company['name']) ? $company['name'] : "" ?>" id="exampleInputName1" placeholder="Name">
            <span class="text-danger" style="font-size: 12px;"><?= isset($errors['name']) ? $errors['name'] : "" ?></span>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail3">Địa chỉ</label>
            <input type="text" name="address" class="form-control" value="<?= isset($company['address']) ? $company['address'] : "" ?>" id="exampleInputEmail3" placeholder="text">
          ...
          <div class="form-group">
            ...
            <input type="hidden" name="location" value="<?= isset($company['location']) ? $company['location'] : "" ?>">
          ...
          <div class="form-group">
            ...
            <textarea class="form" name="description" id="summernote"><?= isset($company['description']) ? $company['description'] : "" ?></textarea>
...
<script>
  ...
  $(document).ready(function() {
    $('#summernote').summernote({
      ...
      fontNamesIgnoreCheck: ['Roboto', 'Arial', 'Open Sans', 'Tahoma'], // Bỏ qua kiểm tra font
      lang: 'vi-VN', // Đặt ngôn ngữ là tiếng Việt
      charset: 'UTF-8',
