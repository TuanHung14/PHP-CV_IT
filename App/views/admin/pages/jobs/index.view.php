  ...
  <div class="card">
    <div class="card-body">
      <div class="d-flex justify-content-between align-items-center">
        <h4 class="card-title">Danh sách job</h4>
          ...
          <tbody>
            ...
            foreach ($jobs as $row): ?>
              <tr>
                ...
                <?php
                $content = "<td><a href='/admin-panel/job/edit/{$row['id']}' class='btn btn-outline-warning'><i class='fa fa-edit'></i></a> </td>";
                echo Template::can('edit_jobs', $content);
                ?>

                <?php
                $content = " <form action='/admin-panel/job/delete/{$row['id']}' method='POST'>
                              <input type='hidden' name='_method' value='DELETE'>
                              <td> <button type='submit' class='btn btn-outline-danger'><i class='fa fa-trash-o'></i></button> </td>
                            </form>";
                echo Template::can('delete_jobs', $content);
                ?>
              </tr>
            <?php endforeach; ?>
          </tbody>
