          ...
          <tbody>
            ...
            foreach ($users as $row): ?>
              <tr>
                ...
                <td> <?= $row['role_name'] ?> </td>
                <?php
                $content = "<td><a href='/admin-panel/user/edit/{$row['id']}' class='btn btn-outline-warning'><i class='fa fa-edit'></i></a> </td>";
            ...
            <?php for ($i = 1; $i <= $count; $i++) {
              if ($i == $page) { ?>
                <li class="page-item active"><button class="page-link"
                    button-pagination="<?= $i ?>"><?= $i ?></button></li>
              <?php  } else {  ?>
                <li class="page-item"><button class="page-link" button-pagination="<?= $i ?>"><?= $i ?></button>
                </li>
            <?php }
            } ?>
