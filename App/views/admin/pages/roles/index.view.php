          ...
          <tbody>
            ...
            foreach ($roles as $row): ?>
              <tr>
                ...
                <?php
                $content = "<td><a href='/admin-panel/role/edit/{$row['id']}' class='btn btn-outline-warning'><i class='fa fa-edit'></i></a> </td>";
                echo Template::can('edit_roles', $content);
                ?>

                <?php
                $content = " <form action='/admin-panel/role/delete/{$row['id']}' method='POST'>
                              <input type='hidden' name='_method' value='DELETE'>
                              <td> <button type='submit' class='btn btn-outline-danger'><i class='fa fa-trash-o'></i></button> </td>
                            </form>";
                echo Template::can('delete_roles', $content);
                ?>
              </tr>
            <?php endforeach; ?>
          </tbody>
